...
# Tabulação Cruzada (2-Way Cross Tabulation)
library(gmodels)
...
## Predict com tipo 'classe' retorna se a variável quality é boa ou não
...
MC <- table(white$quality, white$fx_predito , deparse.level = 2) # montar a matriz de confusão  
